...
const unsigned char keymap[NUMROWS][8] PROGMEM = { // German keymap (C64)
    {KEY_del, 		KEY_3, 		KEY_5, 		KEY_7, 		KEY_9, 		KEY_minus, 		KEY_pgdn, 		KEY_1}, 		   // row0 KEY_del
    ...
    {KEY_F7, 	   KEY_4, 		KEY_6, 		KEY_8, 		KEY_0, 		KEY_equal,     KEY_pgup, 		KEY_2}, 		   // row3 KEY_F4
    {KEY_F1, 		KEY_Z, 		KEY_C, 		KEY_B, 		KEY_M, 		KEY_dot, 		MOD_RSHIFT, 	KEY_spc}, 		// row4 KEY_F1
    {KEY_F3, 		KEY_S, 		KEY_F, 		KEY_H, 		KEY_K, 		KEY_smcol, 		KEY_bckslsh, 	KEY_Euro2}, 	// row5 KEY_F2
    {KEY_F5, 		KEY_E, 		KEY_T, 		KEY_U, 		KEY_O, 		KEY_lbr, 	   KEY_grave,     KEY_Q}, 		   // row6 KEY_F3
